...
- **Secure Login:** Securely log in using your API key, which is stored and encrypted locally on your device.
...
- **App Lock:** Lock the app to prevent unauthorized access.
